jQuery(function ($) {
    ...
    $(".homepage-slides").on("translate.owl.carousel", function(){
        $(".single-slider-item h1, .single-slider-item p").removeClass("animated animate__fadeInUp").css("opacity", "0");
        $(".single-slider-item .slide-btn").removeClass("animated animate__fadeInUp").css("opacity", "0");
    });
    
    $(".homepage-slides").on("translated.owl.carousel", function(){
        $(".single-slider-item h1, .single-slider-item p").addClass("animated animate__fadeInUp").css("opacity", "1");
        $(".single-slider-item .slide-btn").addClass("animated animate__fadeInUp").css("opacity", "1");
    });
