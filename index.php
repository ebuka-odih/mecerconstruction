...
?>
     ...
     <section class="hero-one-section" style="background-image: url(assets/img/bg-two.jpg); ">
        <div class="container">
...
<!--                <h2> We specialize in commercial construction projects that shape thriving business environments. From office complexes to retail spaces, we design and build structures that drive economic growth and serve community needs.</h2>-->
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="cost-effective">
                        <img src="assets/img/cost-effective.jpg" alt="img">
    ...
    <section class="section-innovative gap">
        <div class="container">
            <div class="heading sec-title-animation animation-style2">
                ...
                <h2 class="title-animation">Our Recent Projects</h2>
            </div>
            <div class="swiper innovative-slider">
                <div class="swiper-wrapper">

                    <div class="swiper-slide innovative hover-img">
                        <figure><img src="assets/img/innovative-1.jpg" alt="img"> </figure>
                        <div class="client-company">
                            <h4>Mecer Construction</h4>
                            <h3>Alexa Complex</h3>
                        </div>
                    </div>
                    <div class="swiper-slide innovative hover-img">
                        <figure><img src="assets/img/innovative-2.jpg" alt="img"> </figure>
                        <div class="client-company">
                            <h4>Mecer Construction</h4>
                            <h3>Large Bridge</h3>
                        </div>
                    ...
                    <div class="swiper-slide innovative hover-img">
                        <figure><img src="assets/img/innovative-3.jpg" alt="img"> </figure>
                        <div class="client-company">
                            <h4>Mecer Construction</h4>
                    ...
                    <div class="swiper-slide innovative hover-img">
                        <figure><img src="assets/img/innovative-4.jpg" alt="img"> </figure>
                        <div class="client-company">
                            <h4>Mecer Construction</h4>
    ...
    <section class="faq-section gap no-top">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="accordion-img">
                        <div class="d-flex align-items-center hoverimg">
                            <figure class="accordion-img-1">
                                <img src="assets/img/accordion-img-1.jpg" alt="img">
                            </figure>
                            <figure class="accordion-img-2">
                                <img src="assets/img/accordion-img-2.jpg" alt="img">
                            </figure>
                        </div>
                        <div class="hoverimg">
                            <figure>
                                <img src="assets/img/accordion-img-3.jpg" alt="img">
                            </figure>
                        </div>
                    </div>
                </div>
